...
export const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className=" py-10 bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen"
    >
          ...
          {portfolios.map(({ id, src }) => (
            <div key={id} className="shadow-md shadow-cyan-500 rounded-lg">
              ...
              <div className="flex items-center justify-center">
                <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105  hover:text-cyan-500">
                  Demo
                </button>
                <button className="w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105  hover:text-cyan-500">
                  Code
